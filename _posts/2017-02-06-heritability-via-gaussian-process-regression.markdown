...
phenotypes using a RBF kernel that models higher-order interactions, and found that these estimates
are significantly larger than the narrow-sense heritability of these phenotypes. The authors also
